          ...
          <div className="bg-surface-elevated/80 backdrop-blur-md border border-border hover:border-accent/50 rounded-xl p-6 sm:p-8 flex flex-col justify-between transition-all duration-300 group">
            <div>
              <div className="flex items-center justify-between mb-6">
                <div className="w-10 h-10 rounded-lg bg-accent-muted border border-accent/30 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-accent-foreground transition-all">
            ...
            <div className="rounded-lg bg-surface border border-border p-4">
              <div className="flex items-center justify-between text-xs font-mono">
                <pre className="text-foreground-muted leading-relaxed">
                  <span>
                    Updates:{" "}
                    <span className="text-foreground font-bold">In Real Time</span>
                    {"\n"}
                  </span>
                  <span>
